...
namespace MarsQA.StepDefinitions
{
    ...
    public class ProfileFeatureStepDefinitions
    {
        ...
        public void ThenTheNewLanguageRecordShouldBeAddedSuccessfully()
        {
            ...
            Assert.AreEqual(newLanguage, "Kannada", "Actual and expected result are not equal.");
        }
        ...
        public void ThenTheNewEducationRecordShouldBeAddedSuccessfully()
        {
            ...
            Assert.AreEqual(newEducation, "sjcit University", "Actual and expected skill record do not match.");
        }
